...
import app.infinity.mpvz.ui.browser.music.SharedCompactTrackGridSection
import app.infinity.mpvz.ui.browser.music.SharedMusicCarouselSection
...
fun NavidromeMusicView(
  ...
  val gridCoverArtSizeDp by browserPreferences.musicCoverArtSize.collectAsState()
