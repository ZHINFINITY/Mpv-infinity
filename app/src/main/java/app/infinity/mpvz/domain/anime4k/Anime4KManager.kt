...
package app.infinity.mpvz.domain.anime4k
...
class Anime4KManager(
  ...
  enum class Quality(
    ...
    FAST("S", app.infinity.mpvz.R.string.anime4k_quality_fast),
    BALANCED("M", app.infinity.mpvz.R.string.anime4k_quality_balanced),
    HIGH("L", app.infinity.mpvz.R.string.anime4k_quality_high),
  }
  ...
  enum class Mode(
    ...
    OFF(app.infinity.mpvz.R.string.anime4k_mode_off),
    A(app.infinity.mpvz.R.string.anime4k_mode_a),
    B(app.infinity.mpvz.R.string.anime4k_mode_b),
    C(app.infinity.mpvz.R.string.anime4k_mode_c),
    A_PLUS(app.infinity.mpvz.R.string.anime4k_mode_a_plus),
    B_PLUS(app.infinity.mpvz.R.string.anime4k_mode_b_plus),
    C_PLUS(app.infinity.mpvz.R.string.anime4k_mode_c_plus),
    ARTCNN(app.infinity.mpvz.R.string.anime4k_mode_artcnn),
  }
