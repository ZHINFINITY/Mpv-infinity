...
| --- | --- | --- |
| `user-data/mpvrx/show_text` | Any string | Shows a native Mpv∞ text overlay. |
| `user-data/mpvrx/toggle_ui` | `show`, `hide`, `toggle` | Shows, hides, or toggles player controls. |
| `user-data/mpvrx/show_panel` | Panel id | Opens a native Mpv∞ sheet or panel. |
...
| `user-data/mpvrx/curl_response` | JSON string | Response written by Mpv∞. Scripts should observe it. |
